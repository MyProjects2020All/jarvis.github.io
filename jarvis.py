...
def sendEmail(to,content):
    ...
    server.login('wbhagyashree3@gmail.com','Bhay@230417')
    server.sendmail('wbhagyashree3@gmail.com', to, content)
    server.close()
...
def cpu():
    ...
    speak('The current CPU usage of your laptop is'+usage)
    ...
    while True:
        ...
        if 'time' in query: #tell us time when asked
            ...
            try:
                ...
                speak(content)
                speak("Email has been sent master.")
            ...
            speak("which one should i play Audio songs or Video songs master?")
            answer = TakeCommand().lower()
            if 'audio' in answer:
                songs_dir = 'D:\\Audio songs'
            ...
            speak("I am fine master. Thanks for asking...How are you master? Hope you are doing well")